    ...
    public String guardarReservaCliente(
        ...
        reserva.setMesa(mesaOptional.get());
            try {
                ...
                System.err.println("--- ERROR ClienteReservaController: Formato de fecha/hora inválido: " + e.getMessage() + " ---");
        ...
        reserva.setNotas(notas);
            try {
                ...
                redirectAttributes.addFlashAttribute("error", "Error al realizar la reserva: " + e.getMessage()); // Mensaje de error
                System.err.println("--- ERROR ClienteReservaController: Error al guardar reserva de cliente: " + e.getMessage() + " ---");
            }
